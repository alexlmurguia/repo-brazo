...
void loop(){
 ...
 /////jala
  // String str = "60,0,0,0,0,0,1,0,1";
  // const char del = ',';
  // int dataL = 9;
  // int data[9];
  // int q1, q2, q3, q4, q5, q6, origen, q, dir;
  // int i = 0;
  // while (str.length() > 0) {
  //   int index = str.indexOf(del);  // Encuentra la posición de la coma
  //   if (index == -1) {             // Si no se encuentra más coma, asume que queda un solo valor
  //     data[i++] = str.toInt();     // Convierte el valor a entero y lo almacena en el arreglo
  //     break;                       // Sale del bucle
  //   }
  //   data[i++] = str.substring(0, index).toInt(); // Convierte el valor a entero y lo almacena en el arreglo
  //   str = str.substring(index + 1);               // Elimina el valor procesado de la cadena
  // }

  // // Asigna los valores individuales a las variables
  // q1 = data[0];
  // q2 = data[1];
  // q3 = data[2];
  // q4 = data[3];
  ...
  //////recibe desde serial monitor pero no jala cinematica directa
  // const char del = ',';
  // int dataL = 9;
  // int data[9];
  // int q1, q2, q3, q4, q5, q6, origen, q, dir;
  // String str; // Variable para almacenar la cadena introducida por la terminal
  // int i = 0;

  // Espera a que se introduzca la cadena desde la terminal
  // Verifica si hay datos disponibles en el puerto serial
  if (Serial.available()) {  
    // Lee la cadena introducida desde la terminal
    str = Serial.readStringUntil(';');
    for(int i = 0; i < dataL; i++)
    {
      int index = str.indexOf(del);
